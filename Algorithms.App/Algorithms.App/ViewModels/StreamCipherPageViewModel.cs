...
{
    public class StreamCipherPageViewModel : BaseViewModel
    {
        ...
        public StreamCipherPageViewModel(INavigationService navigationService)
        {
        ...
        {
            EncryptResult = StreamCipher.Encrypt(EncryptBitString, EncryptSeed, EncryptPolynomialBitMask);
        }

        private void Decrypt()
        {
            DecryptResult = StreamCipher.Decrypt(DecryptBitString, DecryptSeed, DecryptPolynomialBitMask);
        }
